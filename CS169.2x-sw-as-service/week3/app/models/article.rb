...
class Article < Content
  ...
  def merge_with(target_id)
    ...
    merged_body     = self.body + target_article.body
    merged_comments = self.comments + target_article.comments
    update_attributes(:body=> merged_body, :comments => merged_comments)
    self.reload
